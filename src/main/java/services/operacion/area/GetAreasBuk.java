...
@ApplicationScoped 
public class GetAreasBuk extends RouteBuilder {
            ...
            .process(new Processor() {
                ...
                public void process(Exchange exchange) throws Exception {
                    ...
                    if (areas != null && !areas.isEmpty()) {
                        ...
                        for (AreaResponse area : uniqueAreas) {
                            // Guardar cada área en la base de datos
                            areaService.save(area.getName(), area.getPublicId());
                        }
